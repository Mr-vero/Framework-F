...
{
    // default connection
    public static $dbname = 'your database name'; // Your database name
    public static $dbuser = 'your database user'; // Your database username
    ...
    // scripts
    public static $load_bootstrap = true; // turn on, if you want to load bootstrap via fRUID
    ...
    public static $start_minimized = false; // Start all fRUID instances minimized.
    ...
    public static $upload_folder_def = '../uploads'; // Default uploads folder on your site, relative to fRUID folder or absolute path required. Folder is must exist.
    ...
    public static $email_from_name = 'fRUID Data Management System'; // email from name
    ...
    // fruit folder url
    public static $scripts_url = ''; // URL to the fRUID folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/fruit' or absolute, e.g. 'http://www.your_site.com/some_folder/fruit'. If empty - will be detected automatically
    ...
    // urls (relative to $scripts_url or fruit's folder, if $scripts_url is not defined)
    ...
    public static $ajax_uri = 'fruit_ajax.php'; // main ajax file or url
    // paths (relative to fruit's folder)
    ...
    public static $autoclean_timeout = 3; // in seconds. Do not change, if not sure. Fruit clears old instances in session when you reload browser tab or open new tab with fruit. In this case Fruit can't work in two tabs in the same time. You can increase timeout on your risk.
    
    
    // anti XSS
    public static $auto_xss_filtering = false; // enable all fruit's POST and GET data filtering
